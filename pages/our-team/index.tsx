...
import * as S from "../../styles/ourTeam";
import { ISeo } from "../../utils/interfaces/ISeo";

const keywords = "team, our-team";

export default function Team({ seo }: { seo: ISeo }) {
  return (
    <>
      <Seo {...seo} />
      <div>
            ...
            <S.TeamMemberContainer className="mb-5">
              ...
              <div>
                ...
                <S.TeamMemberDescription>
                  ...
                  then in the telecommunications industry working at Operations
                  in Ericsson where he oversaw the operations in several
                  countries. In 2015 he invested in several startups with focus
                  in emerging technologies, and in 2016 co-founded ZirconTech in
                  the blockchain space with the domain expert Alejandro
                  Narancio, CEO of Infuy.
                </S.TeamMemberDescription>
              </div>
            ...
            <S.TeamMemberContainer className="my-5">
              ...
              <div>
                ...
                <S.TeamMemberDescription>
                  ...
                  Before co-founding Infuy, another well-known software company
                  in Uruguay, Martin worked in Tata Consultancy Services
                  delivering services to global customers. He has extensive
                  experience in web application development and cloud
                  infrastructure in mission critical operations.
                </S.TeamMemberDescription>
              </div>
            </S.TeamMemberContainer>
            <S.TeamMemberContainer className="my-5">
              ...
              <div>
                ...
                <S.TeamMemberDescription>
                  ...
                  technology strategy and overseeing all technical aspects of
                  the main projects in the company. He has been involved in key
                  global projects in ZirconTech and has performed a key role in
                  the competency development in different blockchain
                  technologies like the evolution of Ethereum into Quorum,
                  Hyperledger, Hedera/Hashgraph, R3 Corda, etc. He was one of
                  the first R3 Corda Certified Developers in Latin America.
                  Williams is a Computer Science engineer who previously worked
                  in the leading IT company from Uruguay Codigo del Sur.
                </S.TeamMemberDescription>
              </div>
            </S.TeamMemberContainer>
            <S.TeamMemberContainer className="my-5">
              ...
              <div>
                ...
                <S.TeamMemberDescription>
                  ...
                  Uruguay in the last decade, expanding to Latin America and
                  North America. Before that, Martin led the Global Delivery
                  Center of Tata Consultancy Services in Montevideo and was Head
                  of the Banking, Financial Services and Insurance Area of the
                  operation. He also worked at IBM, Conaprole, and Banco
                  Comercial which was later acquired by Scotiabank, and was
                  Artificial Intelligence professor in the Universidad Católica
                  del Uruguay.
                </S.TeamMemberDescription>
              </div>
            </S.TeamMemberContainer>
            <S.TeamMemberContainer className="my-5">
              ...
              <div>
                ...
                <S.TeamMemberDescription>
                  ...
                  time at onsite operations in Minneapolis, Miami, Los Angeles
                  and New York City.
                </S.TeamMemberDescription>
              </div>
            </S.TeamMemberContainer>
  ...
  return {
    props: {
      seo: {
        title: "Our Team",
        description:
          "We are a group of passionate about technology. For more than twenty years we have participated in challenging projects forming multicultural groups distributed in different countries, always working with state-of-the-art technology",
        keywords: keywords,
      },
    },
  };
